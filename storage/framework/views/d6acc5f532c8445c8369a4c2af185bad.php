...
<main class="container">
    <section>
        <div class="titlebar">
            <h1>Products</h1>
            <a href="<?php echo e(route('products.create')); ?>" class="btn-Link"><button>Add Product</button></a>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_crud\resources\views/products/index.blade.php ENDPATH**/ ?>